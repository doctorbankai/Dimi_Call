...
export const STATUS_COLORS: Record<ContactStatus, { bg: string; text: string; darkBg: string; darkText: string }> = {
  ...
  [ContactStatus.D0]: { bg: "bg-emerald-100", text: "text-emerald-800", darkBg: "dark:bg-emerald-900/30", darkText: "dark:text-emerald-200" },
  [ContactStatus.R0]: { bg: "bg-green-100", text: "text-green-800", darkBg: "dark:bg-green-900/30", darkText: "dark:text-green-200" },
