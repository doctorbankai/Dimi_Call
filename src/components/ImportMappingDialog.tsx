    ...
    <>
      <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose() }}>
        <DialogContent
          ...
          className="max-w-[95vw] sm:max-w-[90vw] lg:max-w-[1400px] w-full max-h-[95vh] overflow-hidden flex flex-col p-3 sm:p-4 lg:p-6 bg-background text-foreground"
        >
            ...
            <Tabs defaultValue="mapping">
                    ...
                    <div className="grid gap-3 rounded-md border border-amber-200/70 bg-amber-50 dark:bg-amber-900/15 p-3">
                      <div className="flex flex-wrap gap-2">
                        <Button
                          variant="outline"
                          size="sm"
                          className="text-[11px] sm:text-xs h-7 bg-background text-foreground border border-muted-foreground/30 hover:bg-accent hover:text-accent-foreground"
              ...
              <TabsContent value="mapping" className="mt-2">
                <div className="rounded-lg border">
                  <div className="rounded-t-lg bg-card text-card-foreground">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3 p-2 sm:p-3">
                      ...
                      <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="h-7 px-1.5 sm:px-2 text-[10px] sm:text-xs bg-background text-foreground border border-muted-foreground/30 hover:bg-accent hover:text-accent-foreground"
              ...
              <TabsContent value="preview" className="mt-2">
                <div className="rounded-lg border overflow-auto">
                  <table className="w-full text-xs">
                    <thead>
                      <tr className="bg-card text-card-foreground border-b">
                        {headers.map((h, i) => (
            ...
            {detailsSummary.length === 0 ? (
              ...
              detailsSummary.map((item, index) => (
                <div
                  ...
                  className="rounded-md border border-border/70 bg-card text-card-foreground p-3 space-y-2"
                >
