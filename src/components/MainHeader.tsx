...
export const MainHeader: React.FC<MainHeaderProps> = ({
  ...
  return (
    <header className="bg-background text-foreground sticky top-0 z-40 flex h-12 sm:h-14 shrink-0 items-center gap-1 sm:gap-2 border-b backdrop-blur-md transition-[width,height] ease-linear min-w-0">
