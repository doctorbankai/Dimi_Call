...
var __electron_vite_injected_dirname = "C:\\Users\\paulk\\Documents\\Dimi_Call";
    ...
    plugins: [
      ...
      obfuscatorPlugin({
        ...
        options: {
          ...
          // Garde les console.log pour le debug
          domainLock: [],
          ...
          // Peut causer des problèmes avec React
          optionsPreset: "default",
          renameGlobals: false,
          // Important: ne pas renommer les globales
          renameProperties: false,
          // Important: ne pas renommer les propriétés React
          renamePropertiesMode: "safe",
          reservedNames: [],
          reservedStrings: [],
          seed: 0,
          selfDefending: false,
          // Peut causer des problèmes en production
          simplify: true,
          sourceMap: false,
          sourceMapBaseUrl: "",
          sourceMapFileName: "",
          ...
          splitStrings: false,
          // Peut causer des problèmes avec les strings React
          splitStringsChunkLength: 10,
          stringArray: true,
          stringArrayCallsTransform: false,
          // Conservateur pour éviter les problèmes
          ...
          // Important: ne pas transformer les clés d'objets React
